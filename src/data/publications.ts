...
export const publications: Publication[] = [
  {
    ...
    title: 'Toward Affective Empathy via Personalized Analogy Generation',
    venue: 'CHI 2025',
    year: 2025,
    ...
    thumbnail: '/img/pub/chi2025-analogy.jpg',
    links: [
...
export const demonstrations: Publication[] = [
  {
    id: 'P.1',
    type: 'Poster',
    title: 'Chameleon: A Surface-Anchored Smartphone AR Prototype',
    ...
    thumbnail: '/img/pub/uist2025-chameleon.jpg',
    links: [
  ...
  },
  {
    id: 'D.1',
    type: 'Demonstration',
    title: 'Toward Affective Empathy via Personalized Analogy Generation (Demo)',
    ...
    thumbnail: '/img/pub/chi2025-demo.jpg',
    links: [
  ...
  },
  {
    id: 'W.1',
    type: 'Workshop Paper',
    title: 'Chatperone: An LLM-Based Negotiable Scaffolding System',
    ...
    thumbnail: '/img/pub/chi2025-workshop.jpg',
    links: [
